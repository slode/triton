...
# sphinx-quickstart on Thu Sep 27 21:16:01 2012.
#
...
latex_documents = [
  ('index', 'Triton.tex', u'Triton Documentation',
   u'Stian Lode', 'manual'),
]
...
man_pages = [
    ('index', 'triton', u'Triton Documentation',
     [u'Stian Lode'], 1)
]
...
texinfo_documents = [
  ('index', 'Triton', u'Triton Documentation',
   u'Stian Lode', 'Triton', 'One line description of project.',
   'Miscellaneous'),
]
